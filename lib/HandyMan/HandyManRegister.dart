...
Future<void> _registerHandyMan() async {
  ...
  if (_fname.isEmpty || _lname.isEmpty || _username.isEmpty || 
      _password.isEmpty || _contact.isEmpty || _address.isEmpty || 
      _dateOfBirth == null) {
  ...
  try {
    final response = await http.post(
      ...
      body: jsonEncode({
        ...
        'certificatesImages': _certificatesImages.map((file) => file.path).toList(),
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: const Text('Your account has been created successfully. Please wait for a while as we verify your account. Thank you!'),
            actions: [
              TextButton(
                onPressed: () {
